...
export const DAILY_AFFIRMATIONS = [
  "Sabr ye nahi ke aap dard mehsoos nahi karte, sabr ye hai ke aap Allah ke faisle par shikayat nahi karte.",
  "Sabr ek aisi sawari hai jo apne ghursawar ko kabhi girne nahi deti.",
  "Tawakkul ka matlab yeh hai ke jab raste band lagne lagein, tab bhi yeh yaqeen rakhna ke Allah behtar waqt par behtar rasta banayega.",
  "Jab aap kisi faisle par Allah par bharosa karte hain, toh dubara sochne ki zaroorat nahi rehti. Allah aapke liye kaafi ho jata hai.",
  "Sukoon talash karne se nahi milta, sukoon apne Rab ko raazi karne se milta hai.",
  "Ziyada sochna (overthinking) sirf sukoon cheenta hai. Sabr karo, jo tumhara hai wo tumhein hi milega.",
  "Jab dil par bojh barhne lage aur dimaag khamosh na ho, to sajda lamba karo. Sukoon sirf Rab ke aage jhukne mein hai.",
  "Dimaag ke shor ko sabr se khamosh karo. Har cheez apne muqarrar waqt par behtar ho jati hai.",
  "Dimaag ko aaram do, har baat ka matlab nahi nikaala karte; kuch cheezein jaisi hain unhe waise hi chhod dena behtar hai.",
  "Mental peace tab aati hai jab hum har cheez ko control karna chhod dete hain aur use Allah ke hawale kar dete hain.",
  "Sab se bada jihad apne nafs ke khilaf ladna hai. Jo nafs par jeet gaya, wo saari jung jeet gaya.",
  "Taqatwar wo nahi jo kushti jeet le, balki asal taqatwar wo hai jo gusse aur talab ke waqt apne nafs par qaboo rakhe.",
  "Nafs hamesha kehta hai 'Bas ek baar...', lekin rooh kehti hai 'Nahi, mera Allah dekh raha hai'.",
  "Har baar jab tum Allah ki khatir apne nafs ko rokte ho, toh sirf ek gunah se nahi bachte, balki apni rooh ko pahad jaisa mazboot banate ho.",
  "Kamyabi ka raaz is mein hai ki aap apne nafs ki har galat khwahish ko 'NA' kehna seekhein.",
  "Zindagi sirf abhi hai. Beet gaya kal ek sapna hai, aane wala kal ek raaz. Jo tere paas sach mein hai, wo bas ye lamha hai.",
  "Ek gehri saans lo. Jab saans andar lo, to is lamhe se jodo. Jab saans chhodo, to saari fikrein chhod do.",
  "Jahan tumhare paon hain, wahan tumhara dhyan hona chahiye. Hum aksar chalte kahin aur hain aur sochte kahin aur hain.",
  "Insaan ki koshish wahan tak hai jahan tak uski taqat hai, aur Allah ki madad wahan se shuru hoti hai jahan koshish khatam hoti hai.",
  "Waqt sabko milta hai zindagi badalne ke liye, par zindagi dobara nahi milti waqt badalne ke liye.",
  "Tanhai mein ehsaas hota hai ke Rab insaan ke sabse zyada paas hota hai.",
  "Jab duniya ki har taraf se mayus ho jao, tab yaad rakhna ke Allah ke paas sukoon ka darwaza hamesha khula hai.",
  "Namaz sirf ek farz nahi, jab rooh bechain ho toh ye sabse bada marham ban jati hai.",
  "Overthinking se masle hal nahi hote, sirf sukoon barbad hota hai. Apni fikar ko dua mein badlo.",
  "Jo dil Allah par tawakkul karta hai, wahi dunya ke har toofan mein shaant rehta hai.",
  "Urge sirf 5 minute ki ek lehar hai. Agar ye 5 minute sabr kar liya, to tumne poora din jeet liya.",
  "Logon ki parwah karna chhod do. Asal sukoon tab milega jab tumhara maqsad sirf apne Rab ko raazi karna hoga.",
  "Galtiyon par pachtana chhod kar tauba karo aur aage badho. Allah maaf karne walon se sabse zyada mohabbat karta hai.",
  "Duniya mein sabse ameer wo hai jiska dil qana'at (contentment) aur shukr se bhara ho.",
  "Jab sab raste band lagne lagein, to yaad rakhna—tera Rab band deewaron mein se bhi rasta nikalne ki qudrat rakhta hai."
];
